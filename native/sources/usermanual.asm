...
zpvar3=4
zptr3=9
KeyRepeatDelay=$0d ;first keypress repeat delay in frames (x20ms)
KeyRepeatPeriod=$02 ;continuous keyrepeat delay (repetition speed) in frames (x20ms)
...
nokey	lda #KeyRepeatDelay	;no pressed key, repeatcounter resets
        sta repecnt
        rts
...
repeatex                ;repeat-counter routine, return only if repeat can be done (shouldn't affect X or Y registers)
        ...
        lda #KeyRepeatPeriod	;default repeat-speed 2
...
norsrep cmp #KeyRepeatDelay	;check, of repeat counter is initial value (repeatspeed 1)
...
;------------------------------------------------------------------------
*=$1000
.binary "../examples/sid-exports/csillag102.sid",$7e
...
HelpTextFile .binary "../manuals/SID-Wizard-1.9-UserManual.txt"
